function createPricingTable(title, price, index) {
  return `
    <div class="pricing-table position-relative col-3 col-md-6 col-sm-12 d-flex align-items-center justify-content-center text-center">
      <div class="inner-box overflow-hidden position-relative d-flex flex-column align-items-center justify-content-center" style="height: 100%;">
        ...
        <div class="price" style="font-size: 0.75rem; margin-top: 10px;">${price}</div>
      </div>
    </div>
  `;
}
