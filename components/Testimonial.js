        ...
        <div class="testimonial-item bg-white rounded p-3">
          <div class="content mt-2">
            <div class="feed-personalDetails">
              ...
              <a href="#" id="viewMore-${index}" class="view-more text-primary" onclick="toggleTestimonial(${index}, true)">View More</a>
              <a href="#" id="viewLess-${index}" class="view-less text-primary" style="display: none;" onclick="toggleTestimonial(${index}, false)">View Less</a>
